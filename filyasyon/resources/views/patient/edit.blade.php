...
@section('content')
    ...
    <section class="content pt-3">
        ...
        <div class="card">
            ...
            <form class="form-horizontal ajax" action="{{route('patient.update',$patient->id)}}" method="post" id="patient_edit"
                  name="patient_edit">
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="checkbox" id="contacted_status" name="contacted_status"
                                           ...
                                           data-off-color="danger" value="1" {{$patient->contacted_status ?'checked':0}}>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row  has_mutation_id_row d-none">
                                ...
                                <div class="col-sm-7">
                                    <input type="checkbox" id="has_mutation" name="has_mutation"
                                           ...
                                           data-off-color="danger" value="1" {{$patient->has_mutation ?'checked':''}}>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="checkbox" id="is_health_personnel" name="is_health_personnel"
                                           data-on-text="Evet" data-off-text="Hayır" data-on-color="success"
                                           data-off-color="danger" value="1" {{$patient->is_health_personnel ?'checked':''}}>
                                </div>
                            </div>
                            ...
                            <div class="form-group row contact_origin_id_row d-none">
                                <label for="contact_origin_patient_id" class="col-sm-5 col-form-label">Asıl Vaka Adı Soyadı</label>
                                <div class="col-sm-7">
